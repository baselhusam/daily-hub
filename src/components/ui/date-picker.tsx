        ...
        <PopoverTrigger asChild>
          <button
            ...
            className={cn(
              ...
              variant === "compact" &&
                "rounded-md border border-border bg-[#F1F1EF] px-2.5 py-2 text-[13.5px] focus-visible:border-signal focus-visible:ring-[3px] focus-visible:ring-signal/16 dark:bg-muted",
              className
            )}
          >
