...
- [x] Published Docker Hub and GHCR images (`linux/amd64` + `linux/arm64`) on GitHub Releases
- [x] GitHub Actions CI (lint, typecheck, test, build, amd64 and arm64 Docker images)
